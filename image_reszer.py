...
def load_images(src, ext, size):
    ...
    res_imgs = []
    for file in files:
        img = cv2.imread('C:\\Users\\User\\Desktop\\a.png')
        res_imgs.append(('C:\\Users\\User\\Desktop\\a.png', resize_image(img, size)))
        print("\nResizing Image:", src + 'C:\\Users\\User\\Desktop\\a.png')
